/**
 * Process the F-14 Tomcat logo: key white sheet, export upright transparent emblem.
 *
 * Run: node scripts/process-f14-tomcat-logo.mjs
 */
...
const SOURCE = join(__dirname, "assets/f14-tomcat-source.png");
const OUT_MAIN = join(ROOT, "public/assets/fleet-logos/f14_tomcat.png");
const OUT_RADAR = join(ROOT, "public/assets/fleet-logos/radar-transparent/f14_tomcat.png");
const TARGET = 384;

...
export const AI101_GLOSSARY_ENTRIES: readonly Ai101GlossaryCore[] = [
  ...
  { code: "GRID", phrase: "Formation grid", meaning: "Six-wide layout used on the Intel monitor board and Hangar bay matrix for consistent bay math." },
  { code: "GUEST", phrase: "Guest clearance", meaning: "Rank 0 visitor who can open Fleet, Founder, SOS, cockpit handoff, and member login — not Hangar bays." },
  ...
  { code: "NAV", phrase: "Primary navigation", meaning: "Liquid-glass capsule strip listing Fleet, Hangar, Intel, Founder, Origin, Member based on clearance." },
  ...
  { code: "VAULT", phrase: "1995 grit vault", meaning: "Enterprise-only Founder Special 1995 page — gold vault styling distinct from the glass runway." },

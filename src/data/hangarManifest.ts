...
const HANGAR_MANIFEST_CORE: Omit<FleetUnit, "systemPrompt" | "callName">[] = [
  ...
  },
  {
    ...
    domain: "app.hexgen.com",
    href: "https://app.hexgen.com/home",
    status: "active",
    aura: "idle",
    aircraftType: "f35",
    aiName: "Hexgen",
    fleetRole: "Hexgen — AI app workspace at app.hexgen.com/home.",
  },
  {
    id: "2",
    slot: 2,
  ...
  },
  {
    ...
    aircraftType: "x37b",
    aiName: "Alai",
    fleetRole: "Alai — AI presentation and deck builder at getalai.com.",
  },
  {
    id: "8",
    slot: 8,

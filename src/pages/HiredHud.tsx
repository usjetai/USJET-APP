...
const HIRED_HUD_HUB_CARTOON_MP4_FEEDS: readonly HubMp4Feed[] = [
  ...
  {
    src: HIRED_HUD_HUB_FIREFLY_10_VIDEO_SRC,
    ariaLabel: "Hired developer hub Firefly 10 live feed",
    playLabel: "Play Firefly 10 feed",
    feedTag: "Live",
  },
  {

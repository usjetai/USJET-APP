...
/** Hub YouTube window — own tile, play-with-sound on tap. */
export const HIRED_HUD_HUB_YOUTUBE_VIDEO_ID = "-ASqRWm8Yv8" as const;
export const HIRED_HUD_HUB_YOUTUBE_START_SEC = 14;
export const HIRED_HUD_HUB_YOUTUBE_TITLE = "Top 10 Hottest Female Characters In Anime";

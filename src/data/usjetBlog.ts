...
export const USJET_BLOG_POSTS: readonly UsjetBlogPost[] = [
  {
    ...
    subtitle: "Founding dispatch",
    publishedAt: "2026-05-15",
    cadenceDay: 1,
    excerpt:
      "Eight years in the trade. Queens grit. One founder, one runway—this is the honest log of how USJET went from shop floor instinct to computers that already have AI in them.",
    tags: ["Founding", "Operator notes"],
    body: [
      ...
      "The startup phase was not a funding headline. It was fifteen-hour dev sprints after real shifts—translating blue-collar rhythm into code. The thesis: America's shops, crews, and field ops deserve a computer that already thinks, not another chat toy.",
      "USJET.AI is that shop. Operator's Rig computers. Engineering Series books. A founder who still thinks like an operator because he still is one.",
      "If you are reading this, you are early on the runway. Welcome.",
    ],
  },
  {
    ...
    cadenceDay: 4,
    excerpt:
      "usjet.ai is a computer-and-books store: Operator's Rig hardware and the USJET.AI Engineering Series.",
    tags: ["Platform", "Hardware", "Operators"],
    body: [
      "Visitors often ask what usjet.ai is. Here is the straight answer: it is a shop for computers that already have a local assistant on them, plus the books that teach you to run the box.",
      "Homes is the house shop. Business is the shop-and-office shop. Manuals is the Engineering Series. We buy the listed machine, load the stack, and ship it talking.",
      "The shop is one-time hardware and books. A leftover $19.90/mo Stripe link still exists from an earlier version of this site. You do not need it to buy a computer.",
      "AI 101 is the plain-English lesson. Help is orders and shipping. About is Ameer Karim and USJET LLC. That is the storefront.",
      "What it is not: a social network, a replacement for your ERP, or a magic button. It is a computer you own, and the books that ship with it.",
    ],
  },
  {
    slug: "partnership-not-cloning",
    title: "Partnership, Not Cloning: The Operator Rule",
    subtitle: "Human–AI doctrine",
    ...
    body: [
      ...
      "USJET encodes this in AI 101: objective intelligence at machine speed, vision and gut instinct from the human founder. That is how you scale a company without turning the shop into an echo chamber.",
      "The machine learns. The founder leads. Specialized tools stay specialized. Semper Fi.",
    ],
  },
  {

/**
 * Key white sheet off Earhart patrol circular patch — hub badge under glam emojis.
 *
 * Run: node scripts/process-earhart-patrol-patch.mjs
 */
...
const SOURCE = join(ROOT, "scripts/assets/earhart-patrol-patch-source.png");
const OUT = join(ROOT, "public/hired-hud/earhart-patrol-patch.png");

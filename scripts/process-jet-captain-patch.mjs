/**
 * Key white sheet off embroidered jet captain patch — hub badge under glam emojis.
 *
 * Run: node scripts/process-jet-captain-patch.mjs
 */
...
const SOURCE = join(ROOT, "scripts/assets/jet-captain-patch-source.png");
const OUT = join(ROOT, "public/hired-hud/jet-captain-patch.png");

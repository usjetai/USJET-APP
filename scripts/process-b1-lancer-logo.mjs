/**
 * Process the B-1 Lancer logo: key white sheet and watermark haze,
 * keep main line-art silhouette, rotate upright (nose top).
 *
 * Run: node scripts/process-b1-lancer-logo.mjs
 */
...
const SOURCE = join(__dirname, "assets/b1-lancer-source.png");
const OUT_MAIN = join(ROOT, "public/assets/fleet-logos/b1_lancer.png");
const OUT_RADAR = join(ROOT, "public/assets/fleet-logos/radar-transparent/b1_lancer.png");
const TARGET = 384;

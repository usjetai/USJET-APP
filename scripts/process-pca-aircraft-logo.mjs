/**
 * Process the YF-22 / PCA fleet logo: key white sheet, rotate upright (nose top).
 *
 * Run: node scripts/process-pca-aircraft-logo.mjs
 */
...
const SOURCE = join(__dirname, "assets/yf22-source.png");
const OUT_MAIN = join(ROOT, "public/assets/fleet-logos/pca_aircraft.png");
const OUT_RADAR = join(ROOT, "public/assets/fleet-logos/radar-transparent/pca_aircraft.png");
const TARGET = 384;

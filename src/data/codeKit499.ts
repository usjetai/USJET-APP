...
export const CODE_KIT_PACKAGES = [
  ...
  },
  {
    ...
    title: "Stripe & B2B Lead-Gen Templates",
    detail: "High-conversion checkout and enterprise briefing flows — the same architecture behind the $100K and $2,500 tiers.",
  },
] as const;
